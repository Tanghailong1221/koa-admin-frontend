...
export default {
    // Layout
    layout: {
        systemName: 'Tech Management',
        systemSubName: 'Enterprise Admin',
        ...
        noMatchMenu: 'No matching menu found',
        tryOtherKeyword: 'Try other keywords',
        quickOpenSearch: 'Quick open search',
        select: 'Select',
        close: 'Close',
    ...
    form: {
        ...
        inputPlaceholder: 'Please input {field}',
    ...
    file: {
        ...
        uploadLimit: 'Only {types} files can be uploaded',
        uploadSizeLimit: 'File size cannot exceed {size}',
        uploadCountLimit: 'Maximum {count} files can be uploaded',
        uploading: 'Uploading...',
        uploadSuccess: 'Upload successfully',
